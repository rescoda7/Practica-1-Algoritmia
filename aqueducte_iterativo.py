...
def iterative_find_best_aqueducte(aqueducte):
    '''
        Optiene la mejor opcion del acueducto de forma iterativa
    '''
...
def main():
    ...
    if aqueducte_info is None:
        ...
        sys.exit(0)
    best_option, cost = iterative_find_best_aqueducte(aqueducte_info)
